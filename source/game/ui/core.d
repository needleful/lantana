...
void
nk_sdl_device_upload_atlas(ref nk_sdl sdl, const(void*)image, int width, int height)
{
    nk_sdl_device *dev = &sdl.ogl;
...
void
nk_sdl_device_destroy(ref nk_sdl sdl)
{
    nk_sdl_device *dev = &sdl.ogl;
...
void
nk_sdl_render(ref nk_sdl sdl, nk_anti_aliasing AA, int max_vertex_buffer, int max_element_buffer)
{
    nk_sdl_device *dev = &sdl.ogl;
    int width, height;
...
nk_context*
nk_sdl_init(ref nk_sdl sdl, SDL_Window *win)
{
    sdl.win = win;
...
void
nk_sdl_font_stash_begin(ref nk_sdl sdl, nk_font_atlas **atlas)
{
...
void
nk_sdl_font_stash_end(ref nk_sdl sdl)
{
...
void
nk_sdl_handle_grab(ref nk_sdl sdl)
{
...
int
nk_sdl_handle_event(ref nk_sdl sdl, SDL_Event *evt)
{
    nk_context *ctx = &sdl.ctx;
...
void nk_sdl_shutdown(ref nk_sdl sdl)
{
